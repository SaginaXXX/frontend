...
export const Live2D = memo(({ isPet }: Live2DProps): JSX.Element => {
  ...
  // Remove stage: container is full-size; renderer handles scaling internally

  // Force remount when model url changes to guarantee reload
  return (
    <div
      key={modelInfo?.url || 'live2d'}
      ref={containerRef}
      style={{
